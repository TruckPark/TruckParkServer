...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = TruckparkserverApplication.class)
@AutoConfigureMockMvc
public class DirectionPathIntegrationTest {
    ...
    //TODO https://www.google.de/maps/search/rastplatz/@47.741824,8.9834243,19836m/data=!3m1!1e3 rastplätze aufnehmen
...
/*        firestoreRepository.addParkingLot(createParkingLotHtwgKonstanz());
    ...
    @Test
    public void testLinReg() throws Exception {
        MvcResult result = mvc.perform(get("/linreg")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
    }

    private ParkingLot createParkingLotHtwgKonstanz(){
    ...
    private ParkingLot createParkingLotBrandbuehlRastplatzSouth(){
        ParkingLot parkingLot = new ParkingLot(8,
                new com.google.maps.model.LatLng(47.769904, 8.964661),
                new com.google.maps.model.LatLng(47.769770, 8.965391),
    ...
    private ParkingLot createParkingLotBrandbuehlRastplatzNorth(){
        ParkingLot parkingLot = new ParkingLot(12,
                new com.google.maps.model.LatLng(47.770308, 8.966005),
                new com.google.maps.model.LatLng(47.770498, 8.965092),
    ...
    private ParkingLot createParkingLotIsNotInsideDefinedArea(){
        ParkingLot parkingLot = new ParkingLot(12,
                new com.google.maps.model.LatLng(47.770308, 8.966005),
                new com.google.maps.model.LatLng(47.770498, 8.965092),
                new com.google.maps.model.LatLng(47.770689, 8.964946),
